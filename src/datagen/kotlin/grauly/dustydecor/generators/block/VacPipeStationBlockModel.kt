...
object VacPipeStationBlockModel {
    fun get(blockStateModelGenerator: BlockModelGenerators) {
        ...
        blockStateModelGenerator.registerSimpleItemModel(ModItems.VAC_PIPE_STATION, ResourceLocation.fromNamespaceAndPath(DustyDecorMod.MODID, "block/vac_pipe_station/vac_pipe_station"))
    }
