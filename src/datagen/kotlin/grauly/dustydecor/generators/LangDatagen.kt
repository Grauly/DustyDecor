...
class LangDatagen(
    ...
    override fun generateTranslations(wrapper: RegistryWrapper.WrapperLookup, builder: TranslationBuilder) {
        ...
        builder.add(VacPipeStationScreen.COPPER_GOLEM_MODE, "Copper Golem Behavior: ")
        builder.add(VacPipeStationScreen.COPPER_GOLEM_MODE_INTERACT, "Interact")
        builder.add(VacPipeStationScreen.COPPER_GOLEM_MODE_INTERACT_NARRATION, "Interact, Copper Golems will supply capsules, or take received ones")
        builder.add(VacPipeStationScreen.COPPER_GOLEM_MODE_IGNORE, "Ignore")
        builder.add(VacPipeStationScreen.COPPER_GOLEM_MODE_IGNORE_NARRATION, "Ignore, Copper Golems will not interact with this station")
        builder.add(VacPipeStationScreen.REDSTONE_MODE, "Redstone Emission: ")
        builder.add(VacPipeStationScreen.REDSTONE_MODE_ON_RECEIVE, "On Receive")
        builder.add(VacPipeStationScreen.REDSTONE_MODE_ON_RECEIVE_NARRATION, "On Receive, emits a redstone signal when a capsule arrives")
        builder.add(VacPipeStationScreen.REDSTONE_MODE_ON_SEND, "On Send")
        builder.add(VacPipeStationScreen.REDSTONE_MODE_ON_SEND_NARRATION, "On Send, emits a redstone signal when a capsule gets sent")
        builder.add(VacPipeStationScreen.REDSTONE_MODE_WHILE_EMPTY, "While Empty")
        builder.add(VacPipeStationScreen.REDSTONE_MODE_WHILE_EMPTY_NARRATION, "While Empty, emits a redstone signal when no capsule is present")
        builder.add(VacPipeStationScreen.REDSTONE_MODE_NONE, "Never")
        builder.add(VacPipeStationScreen.REDSTONE_MODE_NONE_NARRATION, "Never, does not emit a redstone signal")
        builder.add(VacPipeStationScreen.SENDING_MODE, "Sending Mode: ")
        builder.add(VacPipeStationScreen.SENDING_MODE_MANUAL, "Manual")
        builder.add(VacPipeStationScreen.SENDING_MODE_MANUAL_NARRATION, "Manual, press the GUI button to send a capsule")
        builder.add(VacPipeStationScreen.SENDING_MODE_REDSTONE, "Redstone")
        builder.add(VacPipeStationScreen.SENDING_MODE_REDSTONE_NARRATION, "Redstone, send capsules whenever a redstone signal is present")
        builder.add(VacPipeStationScreen.SENDING_MODE_AUTOMATIC, "Automatic")
        builder.add(VacPipeStationScreen.SENDING_MODE_AUTOMATIC_NARRATION, "Automatic, send a capsule when one is present")
