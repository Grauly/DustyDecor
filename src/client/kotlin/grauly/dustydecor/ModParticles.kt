...
object ModParticles {
    ...
    fun init() {
        ParticleProviderRegistry.getInstance()
            .register(ModParticleTypes.SPARK_PARTICLE, SparkParticle::LargeSparkFactory)
        ParticleProviderRegistry.getInstance()
            .register(ModParticleTypes.SMALL_SPARK_PARTICLE, SparkParticle::SmallSparkFactory)
        ...
        ParticleProviderRegistry.getInstance().register(ModParticleTypes.PHONE_RING, PhoneRingParticleOptions::Factory)
    }
}