...
object VoidGoopOverlayRenderer {
    ...
    private fun drawBlackout(context: GuiGraphicsExtractor, delta: Float) {
        val localMinY = 0
    ...
    private fun drawBlackoutRect(context: GuiGraphicsExtractor, delta: Float, fromX: Int, toX: Int, minY: Int) {
    ...
    private fun getTopY(context: GuiGraphicsExtractor, delta: Float, x: Int): Int {
        return -getOffset(context, delta, x) + context.guiHeight()
    }

    private fun getOffset(context: GuiGraphicsExtractor, delta: Float, x: Int): Int {
